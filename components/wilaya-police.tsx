...
import { AlertCircle, RefreshCw, Shield, Users, Ticket, TrendingUp } from 'lucide-react'
import { Ticket as TicketType, User, DashboardStats } from '@/lib/types'
import { ApiService } from '@/lib/api'

export function WilayaPoliceContent() {
  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Police Portal Overview</h1>
          <p className="text-muted-foreground">Monitor police portal activities and performance</p>
        </div>
